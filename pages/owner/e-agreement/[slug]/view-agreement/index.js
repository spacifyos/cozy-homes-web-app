...
const OwnerViewAgreement = ({ id }) => {
  ...
  return (
    ...
    >
      <div className="body-container bg-color py-4 items-center flex-1">
        <div
...
export default withTranslation("common")(OwnerAuthWrapper(OwnerViewAgreement));
